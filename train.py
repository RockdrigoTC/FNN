...
# Crear capas
layer_1 = Layer(input_size=input, output_size=hidden_size, activation='tanh', weight_init='he', optimizer=optimizer, beta1=beta1, beta2=beta2, dropout=dropout)
layer_2 = Layer(input_size=hidden_size, output_size=output, activation='softmax', weight_init='he', optimizer=optimizer, beta1=beta1, beta2=beta2, dropout=dropout)
...
model.train(X=X_train, y=y_train, x_test=X_test, y_test=y_test , epochs=epoch, learning_rate=learning_rate, batch_size=batch_size, patience=patience)
